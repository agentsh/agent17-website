    ...
    render() {
        return <div>
            ...
            <div className='col-sm-8 col-sm-offset-2'>
                ...
                <p>The Team behind Agent is partnered with „Plattform für digitale Initativen" Our goal is to get the best speakers from around the World to help Dornbirn become an innovation HUB in Europe.</p>
                <p>We started to organize international conferences three years ago, and we have had held several events already including UH15, GameJam and UH16. </p>
                ...
                <p>The importance of software delivery craftsmanship is constantly increasing. Software development made right can unlock huge hidden potential in organizations and help companies to understand how important it is to invest in the way they develop: not just into engineering but into the whole value generation process. Great engineering is not enough. Whole company level agility is necessary. Only those companies that are capable of rapid change and flexibility will survive and thrive in the future. Those organisations that want growth, and are open to experimentation to achieve these goals, will need to focus on and invest in software delivery craftsmanship.</p>

                <Headline type='h3' size='medium' content='What are the three main topics?' style={{textAlign:'left', paddingLeft:0}}/>
                <p>We’re starting out with a strong speaker set focused on current technologies originating from a Javascript Context. In this context best practices (tdd, bdd, ddd, ci, cd, security, performance, service oriented architecture etc.) that can be successfully leveraged by individual engineers. They can learn how to become better in their profession. How they can be more useful from a business point of view (even the most beautiful code worth nothing without representing real business value).</p>
                <p><b>Team and organisational</b> level topics, best practices (agile, devops etc.) that can help companies work more effectively. This includes a diverse set of topics, like how to scale development, how to create great company culture, how to create growing/innovation mind-set, how to create an experimental culture, agile/lean practices etc. It is not easy to evolve from a great engineer to a great leader; Craft will provide great tips on this topic as well.</p>
